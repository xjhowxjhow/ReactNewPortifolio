...
export const CardleftCarrerSrc = {
    ...
    texto2:'Suporte ao cliente de programas de desenvolvimento Microsoft Visual Studio, Azure, Active Directory, E suporte a licenças por volume para empresas e instituições.',
...
export const TextsRepo5 = {
    ...
    texto9:'• Obs: Projeto nao disponivel no GuitHub, pois sera utilizado em um projeto real.',
